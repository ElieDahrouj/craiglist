                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <jet-nav-link :href="route('myAdvert')" >
                                Mes annonces
                            </jet-nav-link>
                            <jet-nav-link :href="route('createAdvert')" >
                                Poster une annonce
                            </jet-nav-link>
                            ...
                            <jet-dropdown align="right" width="48">
                                <template #trigger>
                                    ...
                                    <button v-else class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                        <div>{{ $page.user.name }} <span v-if="$page.user.location_city === null"><font-awesome-icon class="warning" :icon="['fas', 'exclamation-triangle']" /></span></div>
                                ...
                                <template #content>
                                    ...
                                    <jet-dropdown-link :href="route('profile.show')">
                                        Profile <span v-if="$page.user.location_city === null"><font-awesome-icon class="warning" :icon="['fas', 'exclamation-triangle']" /></span>
                                    </jet-dropdown-link>
